      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center px-24 ">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p>
              At CarWale, we're dedicated to making your car buying experience as smooth as the road ahead.
            </p>
          </div>

          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h2 className="text-2xl font-bold mb-4">Contact</h2>
            <p>dodiyameet041@gmail.com</p>
            <p>
              K.T Marg, Vidyavardhini's College of Engineering and Technology, Vasai, Maharashtra, India
            </p>
          </div>
        ...
        <div className="text-center mt-6">
          <p>&copy; 2023 Carwale™. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
    </div>
